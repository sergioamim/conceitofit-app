# Task 449: Consolidar superficies publicas sob o route group (public)
...
## Description
Agrupar landing institucional, B2B e acesso de rede dentro de um boundary interno publico sem introduzir `/public` na URL.
