# Task 447: Melhorar command palette com indexação completa de rotas do backoffice
...
## Description
Indexar todas as rotas /admin/* na command palette com títulos, ícones, tags de busca e seção de ações rápidas.
