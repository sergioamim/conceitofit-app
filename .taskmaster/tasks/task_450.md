...
**Title:** Mover storefront publico para (public) e alinhar rewrites de subdominio
...
**Description:** Migrar a arvore publica do storefront para o boundary (public) mantendo proxy, headers e URLs funcionando.
