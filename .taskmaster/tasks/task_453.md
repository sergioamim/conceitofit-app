...
**Title:** Renomear o route group (app) para (portal) sem alterar URLs operacionais
...
**Description:** Mover a area operacional da academia para um route group (portal), preservando caminhos finais, shell e guardas de sessao.
