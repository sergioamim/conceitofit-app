...
**Title:** Migrar filtros de academia em Segurança/Usuários para SuggestionInput
...
**Description:** Substituir <Select> de academia nos filtros de /admin/seguranca/usuarios por SuggestionInput.
