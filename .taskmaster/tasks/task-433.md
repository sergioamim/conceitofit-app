# Task 433: Criar hooks de busca async para Academia e Unidade (SuggestionInput)
...
## Description
Hooks useAcademiaSuggestion e useUnidadeSuggestion que retornam options/onFocusOpen compatíveis com SuggestionInput, usando TanStack Query.
