# Task 432: Criar componente TableFilters padronizado
...
## Description
Componente declarativo de filtros inline para PaginatedTable, com sincronização de URL search params e suporte a text, suggestion, select, date-range e status-badge.
