# Task 442: Migrar UsuariosTable customizado para PaginatedTable com bulk actions
...
## Description
Substituir componente customizado UsuariosTable em /admin/seguranca/usuarios por PaginatedTable com seleção múltipla e bulk actions.
