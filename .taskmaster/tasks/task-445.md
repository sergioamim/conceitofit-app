# Task 445: Migrar tabela de Saúde Operacional para PaginatedTable
...
## Description
Substituir tabelas de detalhamento em /admin/operacional/saude por PaginatedTable, mantendo cards de status.
