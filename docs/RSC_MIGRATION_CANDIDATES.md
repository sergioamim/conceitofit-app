...
| `(app)/gerencial/contabilidade/page.tsx` | 76 | Layout estático com links |
| `(app)/gerencial/contas-a-pagar/page.tsx` | 33 | Shell com Suspense |
...
|--------|--------|-------|---------|-------------------|
| `(app)/seguranca/rbac/page.tsx` | 162 | 0 | 1 | Extrair tab selector para client island |
| `(app)/vendas/nova/page.tsx` | 77 | 0 | 1 | Extrair form wrapper para client island |
...
| `(app)/crm/playbooks/page.tsx` | 873 | 11 | 2 | 27 |
| `(app)/reservas/page.tsx` | 811 | 17 | 5 | 12 |
| `(app)/gerencial/catraca-acessos/page.tsx` | 773 | 25 | 3 | 8 |
| `(backoffice)/admin/financeiro/cobrancas/page.tsx` | 755 | 19 | 4 | 10 |
| `(app)/prospects/[id]/converter/page.tsx` | 722 | 12 | 3 | 32 |
...
| `(app)/seguranca/acesso-unidade/page.tsx` | 616 | 10 | 5 | 8 |
| `(app)/conta/aulas/page.tsx` | 335 | 5 | 2 | 5 |
| `(app)/crm/tarefas/page.tsx` | 567 | 12 | 2 | 10 |
| `(backoffice)/admin/configuracoes/page.tsx` | 605 | 8 | 2 | 9 |
| `(app)/gerencial/recebimentos/page.tsx` | 506 | 14 | 2 | 12 |
