...
export function TransacoesContent({ initialData }: TransacoesContentProps) {
  ...
  const { items: transacoesFromQuery, isLoading: loading, error: loadError, refetch, create } = useAdminCrud<
  ...
  const transacoes = transacoesFromQuery.length > 0 ? transacoesFromQuery : initialData;
