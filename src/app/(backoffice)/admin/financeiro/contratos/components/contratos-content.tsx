...
export type ContratosContentProps = {
  initialContratos: ContratoPlataforma[];
  initialAcademias: Academia[];
  initialPlanos: PlanoPlataforma[];
};
...
export function ContratosContent({ initialContratos, initialAcademias, initialPlanos }: ContratosContentProps) {
  ...
  const academias = academiasQuery.data ?? initialAcademias;
  const planos = planosQuery.data ?? initialPlanos;
